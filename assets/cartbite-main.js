if(!window.initVar){
  window.initVar = {
    ...
    meta: {},
    vapidKey: "BBPGJZ-yHHB2HgdECmLpLwB74lhYHjEU-Smn0nW3zR-1_-Uy8T0enuaSz_7eubnc0EEgEWf2JBWVhnB1soqg45U",
    clientId: "YQ3F16C9CZW66Q51HXWY9BG8",
    ...
    stockFulFilledPushCampaign: {
      isActive: true,
      uniqueId: '5ZRVRUPGGD2QHWTHS2YK517P'
    },
    stockFulFilledEmailCampaign: {
      isActive: true,
      uniqueId: '6NGY547NXAGWYQ1W78KVMDV7'
    },
    stockFulFilledSmsCampaign: {
      isActive: true,
      uniqueId: 'SZ8V9CL5A9EHA1E1Y9LZXGMQ'
    },
    priceDropPushCampaign: {
      isActive: true,
      uniqueId: 'QHVIDYCD2PCZJIRA7QDA32VP',
    },
    priceDropEmailCampaign: {
      isActive: true,
      uniqueId: 'SQE6QXG53W73E3A4R563FZ1P',
    },
    priceDropSmsCampaign: {
      isActive: true,
      uniqueId: '7A7WNLTQI62ISLQBGRLFY9ZU',
    },
    stockWidget: {
  ...
  window.onload = function () {
    window.growCampaignPopUp = new Vue({
      ...
      data: {
        ...
        emailWorkflowUniqueId: "6NGY547NXAGWYQ1W78KVMDV7",
        smsWorkflowUniqueId: "SZ8V9CL5A9EHA1E1Y9LZXGMQ",
